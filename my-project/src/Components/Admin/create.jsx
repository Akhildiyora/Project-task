          ...
          <div className='bg-zinc-900/80 p-4 sm:p-6 rounded-lg shadow-2xl w-full sm:min-w-lg sm:max-w-2xl border flex flex-col gap-4 border-zinc-800'>
            <form onSubmit={handleSubmit} className=" flex flex-col gap-4 ">
              ...
              <div>
                ...
                <input required name='due_date' type="date" min={new Date().toISOString().split("T")[0]} className="mx-1 scheme-light-dark bg-zinc-800/30 text-white py-1 px-2 sm:p-2 sm:px-4 text-sm sm:text-md rounded-lg border border-zinc-700/30 hover:border-zinc-700 focus:outline-none focus:ring-1 focus:ring-blue-500/40 w-full" />
              </div>
              <div>
